...
class BackgroundRenderer:
    ...
    def render(self, background_config: BackgroundConfig, canvas: Image.Image) -> None:
        ...
        try:
            if background_config.type == "solid":
                ...
                raise BackgroundRenderError(f"Unknown background type: {background_config.type}")
                
        except Exception as e:
            raise BackgroundRenderError(f"Failed to render {background_config.type} background: {e}") from e
    ...
    def _render_linear_gradient(self, config: BackgroundConfig, canvas: Image.Image) -> None:
    ...
    def _render_radial_gradient(self, config: BackgroundConfig, canvas: Image.Image) -> None:
        ...
        gradient = self._create_radial_gradient(width, height, colors, (center_x, center_y))
        canvas.paste(gradient, (0, 0))
    
    def _render_conic_gradient(self, config: BackgroundConfig, canvas: Image.Image) -> None:
        ...
        gradient = self._create_conic_gradient(width, height, colors, (center_x, center_y))
        canvas.paste(gradient, (0, 0))
    ...
    def _create_linear_gradient(self, width: int, height: int, colors: List[Tuple[int, int, int, int]], direction: float) -> Image.Image:
    ...
    def _create_radial_gradient(self, width: int, height: int, colors: List[Tuple[int, int, int, int]], center: Tuple[int, int]) -> Image.Image:
    ...
    def _create_conic_gradient(self, width: int, height: int, colors: List[Tuple[int, int, int, int]], center: Tuple[int, int]) -> Image.Image:
    ...
    def _interpolate_colors(self, colors: List[Tuple[int, int, int, int]], t: float) -> Tuple[int, int, int, int]:
